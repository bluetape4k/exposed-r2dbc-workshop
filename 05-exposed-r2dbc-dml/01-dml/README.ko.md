...
![예제 테이블 구조 (ER 다이어그램) 1](../../docs/images/readme-diagrams/05-exposed-r2dbc-dml-01-dml-ko-diagram-01.svg)

## DSL API 구조 (클래스 다이어그램)

![DSL API 구조 (클래스 다이어그램) 2](../../docs/images/readme-diagrams/05-exposed-r2dbc-dml-01-dml-ko-diagram-02.svg)
...
sequenceDiagram
    ...
    Note over App,DB: UPSERT 흐름 (Ex04_Upsert)
    ...
    Note over App,DB: batchUpsert 흐름
