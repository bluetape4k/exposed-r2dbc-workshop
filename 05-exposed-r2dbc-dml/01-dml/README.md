...
![Example Table Structure (ER Diagram) diagram](../../docs/images/readme-diagrams/05-exposed-r2dbc-dml-01-dml-erd-01.png)

## DSL API Structure (Class Diagram)

![DSL API Structure (Class Diagram) diagram](../../docs/images/readme-diagrams/05-exposed-r2dbc-dml-01-dml-class-02.png)

## CTE / UPSERT Execution Flow (Sequence Diagram)

![CTE / UPSERT Execution Flow (Sequence Diagram) diagram](../../docs/images/readme-diagrams/05-exposed-r2dbc-dml-01-dml-sequence-03.png)
