...
class Ex09_GroupBy: R2dbcExposedTestBase() {
    ...
    fun `groupBy example 01`(testDB: TestDB) = runTest {
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun `groupBy example 02`(testDB: TestDB) = runTest {
        withCitiesAndUsers(testDB) { cities, users, _ ->
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun `groupBy example 03`(testDB: TestDB) = runTest {
        withCitiesAndUsers(testDB) { cities, users, _ ->
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun `groupBy example 04`(testDB: TestDB) = runTest {
        withCitiesAndUsers(testDB) { cities, users, _ ->
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun `groupBy example 06`(testDB: TestDB) = runTest {
        withCitiesAndUsers(testDB) { cities, users, _ ->
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun `groupBy example 07`(testDB: TestDB) = runTest {
        withCitiesAndUsers(testDB) { cities, users, _ ->
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun `group concat`(testDB: TestDB) = runTest {

        withCitiesAndUsers(testDB) { cities, users, _ ->
            suspend fun <T: String?> GroupConcat<T>.checkExcept(
