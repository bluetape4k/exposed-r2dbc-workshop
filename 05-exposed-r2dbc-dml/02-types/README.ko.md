...
![구조 다이어그램 1](../../docs/images/readme-diagrams/05-exposed-r2dbc-dml-02-types-ko-diagram-01.svg)

## Kotlin 타입 → DB 타입 매핑 흐름

![Kotlin 타입 → DB 타입 매핑 흐름 2](../../docs/images/readme-diagrams/05-exposed-r2dbc-dml-02-types-ko-diagram-02.svg)
