...
class Ex07_UnsignedColumnType: R2dbcExposedTestBase() {
    ...
    fun `test UByteColumnType`(testDB: TestDB) = runTest {
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun testPreviousUByteColumnTypeWorksWithNewSmallIntType(testDB: TestDB) = runTest {
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun testUShortColumnType(testDB: TestDB) = runTest {
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun testUShortWithCheckConstraint(testDB: TestDB) = runTest {
        withTables(testDB, UShortTable) {
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun testPreviousUShortColumnTypeWorksWithNewIntType(testDB: TestDB) = runTest {
        withDb(testDB) {
            try {
                val tableName = UShortTable.nameInDatabaseCase()
                val columnName = UShortTable.unsignedShort.nameInDatabaseCase()
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun testUIntColumnType(testDB: TestDB) = runTest {
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun testUIntWithCheckConstraint(testDB: TestDB) = runTest {
        withTables(testDB, UIntTable) {
            val ddlEnding = if (currentDialectTest is MysqlDialect) {
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun testPreviousUIntColumnTypeWorksWithNewBigIntType(testDB: TestDB) = runTest {
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun testULongColumnType(testDB: TestDB) = runTest {
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun testMaxULongColumnType(testDB: TestDB) = runTest {
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun testMaxUnsignedTypesInMySql(testDB: TestDB) = runTest {
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun testCheckConstraintNameAcrossMultipleTables(testDB: TestDB) = runTest {
