...
import org.jetbrains.exposed.v1.core.cumeDist
import org.jetbrains.exposed.v1.core.decimalLiteral
import org.jetbrains.exposed.v1.core.denseRank
import org.jetbrains.exposed.v1.core.firstValue
import org.jetbrains.exposed.v1.core.intLiteral
import org.jetbrains.exposed.v1.core.lag
import org.jetbrains.exposed.v1.core.lastValue
import org.jetbrains.exposed.v1.core.lead
import org.jetbrains.exposed.v1.core.max
import org.jetbrains.exposed.v1.core.min
import org.jetbrains.exposed.v1.core.minus
import org.jetbrains.exposed.v1.core.nthValue
import org.jetbrains.exposed.v1.core.ntile
import org.jetbrains.exposed.v1.core.percentRank
...
class Ex05_WindowFunction: Ex00_FunctionBase() {
    ...
    fun `윈도우 함수 기본 사용법`(testDB: TestDB) = runTest {
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun `집계함수를 윈도우 함수로 사용하기`(testDB: TestDB) = runTest {
        Assumptions.assumeTrue { testDB != TestDB.MYSQL_V5 }
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun `partitionBy 절 적용에 따른 소계`(testDB: TestDB) = runTest {
        Assumptions.assumeTrue { testDB != TestDB.MYSQL_V5 }
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun `orderBy 적용에 따른 소계`(testDB: TestDB) = runTest {
        Assumptions.assumeTrue { testDB != TestDB.MYSQL_V5 }
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun `WindowFrameBound 종류별 결과값 비교`(testDB: TestDB) = runTest {
        Assumptions.assumeTrue { testDB != TestDB.MYSQL_V5 }
     ...
     */
    private suspend fun <T> DMLTestData.Sales.assertWindowFunctionDefinition(
