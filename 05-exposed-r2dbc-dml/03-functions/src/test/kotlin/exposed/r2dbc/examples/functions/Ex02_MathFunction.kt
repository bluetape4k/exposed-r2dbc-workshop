...
class Ex02_MathFunction: Ex00_FunctionBase() {
    ...
    fun `abs function`(testDB: TestDB) = runTest {
        withTable(testDB) {
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun `sign function`(testDB: TestDB) = runTest {
        withTable(testDB) {
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun `floor function`(testDB: TestDB) = runTest {
        withTable(testDB) {
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun `ceil function`(testDB: TestDB) = runTest {
        withTable(testDB) {
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun `power function`(testDB: TestDB) = runTest {
        withTable(testDB) {
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun `round function`(testDB: TestDB) = runTest {
        withTable(testDB) {
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun `sqrt function`(testDB: TestDB) = runTest {
        withTable(testDB) {
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun `exp function`(testDB: TestDB) = runTest {
        withTable(testDB) {
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun `Column Reference In Default Expression in MySQL`(testDB: TestDB) = runTest {
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun `ln function`(testDB: TestDB) = runTest {
        withTable(testDB) {
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun `log function`(testDB: TestDB) = runTest {
        withTable(testDB) {
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun `log10 function`(testDB: TestDB) = runTest {
        withTable(testDB) {
