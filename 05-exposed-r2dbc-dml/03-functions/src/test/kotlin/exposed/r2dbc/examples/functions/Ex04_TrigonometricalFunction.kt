...
class Ex04_TrigonometricalFunction: Ex00_FunctionBase() {
    ...
    fun `ACosFunction test`(testDB: TestDB) = runTest {
        withTable(testDB) {
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun `ASinFunction test`(testDB: TestDB) = runTest {
        withTable(testDB) {
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun `ATanFunction test`(testDB: TestDB) = runTest {
        withTable(testDB) {
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun `CosFunction test`(testDB: TestDB) = runTest {
        withTable(testDB) {
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun `CotFunction test`(testDB: TestDB) = runTest {
        withTable(testDB) {
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun `DegreesFunction test`(testDB: TestDB) = runTest {
        withTable(testDB) {
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun `PiFunction test`(testDB: TestDB) = runTest {
        withTable(testDB) {
            when (testDB) {
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun `SinFunction test`(testDB: TestDB) = runTest {
        withTable(testDB) {
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun `TanFunction test`(testDB: TestDB) = runTest {
        withTable(testDB) {
