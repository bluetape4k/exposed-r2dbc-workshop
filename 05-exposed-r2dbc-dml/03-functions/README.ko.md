...
![함수 카테고리 1](../../docs/images/readme-diagrams/05-exposed-r2dbc-dml-03-functions-ko-diagram-01.svg)

## 함수 클래스 계층 (클래스 다이어그램)

![함수 클래스 계층 (클래스 다이어그램) 2](../../docs/images/readme-diagrams/05-exposed-r2dbc-dml-03-functions-ko-diagram-02.svg)
