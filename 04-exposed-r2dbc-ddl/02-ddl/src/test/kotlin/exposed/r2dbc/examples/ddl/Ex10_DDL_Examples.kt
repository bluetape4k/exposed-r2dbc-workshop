...
class Ex10_DDL_Examples: R2dbcExposedTestBase() {
    ...
    @Test
    fun `keyword identifiers with opt out`() = runTest {
...
//            statements.isEmpty().shouldBeTrue()
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun `keyword identifiers without opt out`(testDB: TestDB) = runTest {
...
//            statements.shouldBeEmpty()
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun `unnamed table with quoted SQL`(testDB: TestDB) = runTest {
    ...
    @Test
    fun `namedEmptyTable without quotes SQL`() = runTest {
    ...
    suspend fun `table with different column types SQL 01`() {
        /**
         * ```sql
         * -- H2
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun `table with different column types SQL 02`(testDB: TestDB) = runTest {
     ...
     */
    @Test
    fun `primary key on text column in H2`() = runTest {
        /**
         * ```sql
         * -- H2
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun `indices 02`(testDB: TestDB) = runTest {
        /**
         * ```sql
     ...
     */
    @Test
    fun `index on text column in H2`() = runTest {
        /**
         * ```sql
         * -- H2
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun `binary without length`(testDB: TestDB) = runTest {
     ...
     */
    @Test
    fun `escape string column type`() = runTest {
        withDb(TestDB.H2) {
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun `complex test 01`(testDB: TestDB) = runTest {
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun `cross reference`(testDB: TestDB) = runTest {
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun `boolean column type`(testDB: TestDB) = runTest {
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun `table with different text type`(testDB: TestDB) = runTest {
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun `delete missing table`(testDB: TestDB) = runTest {
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun `check contraints 01`(testDB: TestDB) = runTest {
        Assumptions.assumeTrue { testDB != TestDB.MYSQL_V5 }
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun `check constraint 02`(testDB: TestDB) = runTest {
        Assumptions.assumeTrue { testDB != TestDB.MYSQL_V5 }
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun `create and drop check constraint`(testDB: TestDB) = runTest {
    ...
    @Test
    fun `eq operator without DB connection`() = runTest {
        object: Table("test") {
    ...
    @Test
    fun `neq operator without DB connection`() = runTest {
        object: Table("test") {
            val testColumn = integer("test_column").nullable()
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun `inner join with multiple foreignkey`(testDB: TestDB) = runTest {
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun `create table with foreign key to another schema`(testDB: TestDB) = runTest {
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun `composite FK referencing unique index`(testDB: TestDB) = runTest {
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun `composite FK referencing primary key`(testDB: TestDB) = runTest {
        val tableA = object: Table("TableA") {
            val idA = integer("id_a")
            val idB = integer("id_b")
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun `multiple FK`(testDB: TestDB) = runTest {
        val tableA = object: Table("TableA") {
            val idA = integer("id_a")
            val idB = integer("id_b")
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun `create table with composite primary key and schema`(testDB: TestDB) = runTest {
