...
![Structure Diagram diagram](../../docs/images/readme-diagrams/04-exposed-r2dbc-ddl-02-ddl-class-01.png)

![Structure Diagram diagram](../../docs/images/readme-diagrams/04-exposed-r2dbc-ddl-02-ddl-architecture-02.png)

---

## Sample Table ERD (Users / Orders / Products)

![Sample Table ERD (Users / Orders / Products) diagram](../../docs/images/readme-diagrams/04-exposed-r2dbc-ddl-02-ddl-erd-03.png)

---

## Schema Migration Flow

![Schema Migration Flow diagram](../../docs/images/readme-diagrams/04-exposed-r2dbc-ddl-02-ddl-sequence-04.png)
