 ...
 * @property password Ktor 인증에 저장할 원문 비밀번호입니다. repository에서 hash로 변환합니다.
 * @property displayName 응답과 세션 profile에 표시할 이름입니다. 생략하면 [username]을 사용합니다.
 * @property roles Ktor principal에 연결할 role 집합입니다.
 */
...
/**
 * idempotency key와 함께 저장해야 하는 outbound 작업 요청입니다.
 *
 ...
 * @property roles Ktor principal에 노출할 role 집합입니다.
 */
@kotlinx.serialization.Serializable
...
/**
 * Ktor basic authentication이 request pipeline에 설치하는 principal입니다.
 *
 * @property username 인증된 계정 이름입니다.
 * @property displayName 응답에 표시할 계정 이름입니다.
 * @property permission 계정에 부여된 workshop 권한입니다.
 * @property roles 인증 후 route 권한 확인에 사용할 role 집합입니다.
 */
...
/**
 * Ktor 인증 slice가 반환하는 인증된 profile입니다.
 *
...
/**
 * Ktor 인증 slice가 저장하는 세션 metadata입니다.
 *
...
/**
 * Ktor application slice가 반환하는 작업 항목 응답입니다.
 *
...
/**
 * realtime replay가 반환하는 저장된 outbox event입니다.
 *
...
/**
 * outbound HTTP outbox slice가 반환하는 요청 응답입니다.
 *
...
/**
 * Ktor handler가 공유하는 구조화된 API 오류입니다.
 *
