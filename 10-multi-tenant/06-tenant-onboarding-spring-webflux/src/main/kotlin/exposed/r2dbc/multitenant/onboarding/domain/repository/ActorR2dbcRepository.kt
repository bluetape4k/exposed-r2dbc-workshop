...
/**
 * Repository for actor records in the current tenant transaction.
 *
 * The caller must execute repository methods inside [TenantTransactionExecutor]
 * so Exposed obtains connections from the routing database.
 */
@Repository
class ActorR2dbcRepository: R2dbcRepository<Long, ActorRecord> {
    ...
    /**
     * Searches actors in the current tenant transaction using optional column parameters.
     */
