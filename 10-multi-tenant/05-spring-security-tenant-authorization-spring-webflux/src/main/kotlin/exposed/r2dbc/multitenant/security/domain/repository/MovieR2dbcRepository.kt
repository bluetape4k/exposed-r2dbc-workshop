package exposed.r2dbc.multitenant.security.domain.repository

import exposed.r2dbc.multitenant.security.domain.model.MovieActorCountRecord
import exposed.r2dbc.multitenant.security.domain.model.MovieRecord
import exposed.r2dbc.multitenant.security.domain.model.MovieSchema.ActorInMovieTable
import exposed.r2dbc.multitenant.security.domain.model.MovieSchema.ActorTable
import exposed.r2dbc.multitenant.security.domain.model.MovieSchema.MovieTable
import exposed.r2dbc.multitenant.security.domain.model.MovieWithActorRecord
import exposed.r2dbc.multitenant.security.domain.model.MovieWithProducingActorRecord
import exposed.r2dbc.multitenant.security.domain.model.toActorRecord
import exposed.r2dbc.multitenant.security.domain.model.toMovieRecord
import exposed.r2dbc.multitenant.security.domain.model.toMovieWithActorRecord
import exposed.r2dbc.multitenant.security.domain.model.toMovieWithProducingActorRecord
...
/**
 * Repository for movie records in the current tenant transaction.
 *
 * The caller must execute repository methods inside the tenant routing
 * transaction boundary so all reads and writes use the selected tenant pool.
 */
@Repository
