...
sequenceDiagram
    ...
    DB -->> Repo: Korean actor data
    Repo -->> Controller: List~ActorRecord~
    Controller -->> Client: JSON response (Korean data)
```

## Tenant Context Propagation Flow

![Tenant Context Propagation Flow 1](../../docs/images/readme-diagrams/10-multi-tenant-03-multitenant-spring-webflux-diagram-01.svg)

## TenantAwareRepository Class Structure

![TenantAwareRepository Class Structure 2](../../docs/images/readme-diagrams/10-multi-tenant-03-multitenant-spring-webflux-diagram-02.svg)
