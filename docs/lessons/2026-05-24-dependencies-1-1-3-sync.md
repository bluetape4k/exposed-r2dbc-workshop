...
`exposed-r2dbc-workshop` was still consuming `bluetape4k-dependencies = "1.1.1"`.
...
- `./gradlew -q :exposed-r2dbc-shared:dependencyInsight --configuration compileClasspath --dependency org.jetbrains.exposed:exposed-core`
  resolved `org.jetbrains.exposed:exposed-core:1.3.0` through
  `io.github.bluetape4k:bluetape4k-dependencies:1.1.3`.
