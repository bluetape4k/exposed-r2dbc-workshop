# 전체 모듈 검토 및 문서화 구현 계획

> **작업자 참고:** 이 계획을 구현할 때는 사용 가능한 경우 superpowers:subagent-driven-development를 사용하고, 그렇지 않으면 superpowers:executing-plans를 사용한다. 진행 상태는 checkbox(`- [ ]`)로 추적한다.

**목표:** exposed-r2dbc-workshop 전체 모듈에 대해 코드 리뷰 + 테스트 KDoc 보강 + README 개선을 병렬로 수행한다.

**아키텍처:** 7개 청크로 나누어 독립적 모듈 그룹별로 병렬 subagent를 투입한다. 각 subagent는 (1) 테스트 파일 읽기 → (2) 코드 이슈 수정 → (3) KDoc 누락 보완 → (4) README 개선 → (5) 커밋 순서로 작업한다.

**기술 스택:** Kotlin 2.2, JetBrains Exposed v1 R2DBC, JUnit5 ParameterizedTest, KDoc, Markdown
...
### 작업 1: 00-shared/exposed-r2dbc-shared
...
- [ ] **단계 2: AbstractR2dbcExposedTest KDoc 보강**
...
- [ ] **단계 1: 파일 읽기 및 코드 이슈 파악**

- [ ] **단계 2: 코드 이슈 수정**
  - `!!` 사용 검토 및 교체
  - `companion object` 확인

- [ ] **단계 3: 각 테스트 파일 KDoc 보강**
...
**파일:** `Ex01_Select.kt` ~ `Ex99_Dual.kt` + `README.md`
...
### 작업 8: 06-advanced/01-exposed-r2dbc-crypt

**파일:** `Ex01_EncryptedColumn.kt`, `README.md`
...
### 작업 9: 06-advanced/02-exposed-r2dbc-javatime

**파일:** `Ex01_JavaTime.kt`, `Ex02_Defaults.kt`, `Ex03_DateTimeLiteral.kt`, `Ex04_MiscTable.kt`, `README.md`
...
### 작업 10: 06-advanced/03-exposed-r2dbc-kotlin-datetime

**파일:** `Ex01_KotlinDateTime.kt`, `Ex02_Defaults.kt`, `Ex03_DateTimeLiteral.kt`, `KotlinDateTimeSupports.kt`, `README.md`
...
### 작업 11: 06-advanced/04-exposed-r2dbc-json

**파일:** `Ex01_JsonColumn.kt`, `Ex02_JsonBColumn.kt`, `JsonTestData.kt`, `R2dbcExposedJsonTest.kt`, `README.md`
...
### 작업 12: 06-advanced/05-exposed-r2dbc-money
...
### 작업 13: 06-advanced/06-exposed-r2dbc-custom-columns
...
### 작업 14: 06-advanced/07-exposed-r2dbc-custom-entities
...
### 작업 15: 06-advanced/08-exposed-r2dbc-jackson
...
### 작업 16: 06-advanced/09, 10, 11, 12 (fastjson2, jasypt, jackson3, tink)
...
### 작업 17: 07-jpa-convert/01-convert-jpa-basic

**파일:** `ex01_simple/`, `ex02_entities/`, `ex03_customId/`, `README.md`
...
### 작업 22: 루트 README.md 최종 업데이트

- [ ] **단계 1: 현재 루트 README 읽기**
  ```bash
  cat README.md
  ```
...
### 작업 23: 01-spring-boot/spring-webflux-exposed
