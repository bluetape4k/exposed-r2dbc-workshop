...
exposed {
    migrations {
        tablesPackage = "exposed.r2dbc.examples"
        databaseUrl = "jdbc:h2:mem:09-spring-05-exposed-r2dbc-repository-coroutines-migrations;DB_CLOSE_DELAY=-1;MODE=PostgreSQL"
        databaseUser = "sa"
        databasePassword = ""
    }
}
...
springBoot {
    mainClass.set("exposed.r2dbc.examples.ExposedR2dbcRepositoryAppKt")
