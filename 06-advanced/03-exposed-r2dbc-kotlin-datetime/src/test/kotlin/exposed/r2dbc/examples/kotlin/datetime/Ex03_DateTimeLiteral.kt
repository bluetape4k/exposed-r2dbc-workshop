...
class Ex03_DateTimeLiteral: AbstractR2dbcExposedTest() {
    ...
    fun testSelectByDateLiteralEquality(testDB: TestDB) = runTest {
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun testSelectByDateLiteralComparison(testDB: TestDB) = runTest {
        withTables(testDB, TableWithDate) {
            TableWithDate.insert {
                it[date] = defaultDate
            }
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun testSelectByDatetimeLiteralEquality(testDB: TestDB) = runTest {
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun testSelectByDatetimeLiteralComparison(testDB: TestDB) = runTest {
        withTables(testDB, TableWithDatetime) {
            TableWithDatetime.insert {
                it[datetime] = defaultDatetime
            }
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun testSelectByTimestampLiteralEquality(testDB: TestDB) = runTest {
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun testSelectByTimestampLiteralComparison(testDB: TestDB) = runTest {
        withTables(testDB, TableWithTimestamp) {
            TableWithTimestamp.insert {
                it[timestamp] = defaultTimestamp
            }
