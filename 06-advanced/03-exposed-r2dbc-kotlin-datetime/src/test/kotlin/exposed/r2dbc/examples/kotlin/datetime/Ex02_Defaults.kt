...
//    }
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun testRawBatchInsertFails01(testDB: TestDB) = runTest {
        withTables(testDB, TableWithDBDefault) {
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun testBatchInsertNotFails01(testDB: TestDB) = runTest {
        withTables(testDB, TableWithDBDefault) {
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun testBatchInsertFails01(testDB: TestDB) = runTest {
        withTables(testDB, TableWithDBDefault) {
            expectException<BatchDataInconsistentException> {
...
//                    } +
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun testDefaultExpressions01(testDB: TestDB) = runTest {
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun testDefaultExpressions02(testDB: TestDB) = runTest {
        /**
         * ```sql
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun testBetweenFunction(testDB: TestDB) = runTest {
        /**
         * ```sql
         * CREATE TABLE IF NOT EXISTS tester (
         *      id SERIAL PRIMARY KEY,
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun testTimestampWithTimeZoneDefaults(testDB: TestDB) = runTest {
        // UTC time zone
...
//                    } +
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun testColumnOnUpdateCurrentTimestamp(testDB: TestDB) = runSuspendIO {
        val tester = object: Table("tester") {
