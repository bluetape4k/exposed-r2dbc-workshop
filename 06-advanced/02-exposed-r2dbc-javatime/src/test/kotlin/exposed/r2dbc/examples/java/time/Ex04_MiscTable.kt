...
class Ex04_MiscTable: R2dbcExposedTestBase() {
    ...
    fun `insert 01`(testDB: TestDB) = runTest {
        val tbl = Misc
        val date = today
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun `insert 02`(testDB: TestDB) = runTest {
        val tbl = Misc
        val date = today
        val time = LocalTime.now()
        val dateTime = LocalDateTime.now()
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun `insert 03`(testDB: TestDB) = runTest {
        val tbl = Misc
        val date = today
        val time = LocalTime.now()
        val dateTime = LocalDateTime.now()
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun `insert 04`(testDB: TestDB) = runTest {
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun `insert and get`(testDB: TestDB) = runTest {
        val tbl = Misc
        val date = today
        val time = LocalTime.now()
        val dateTime = LocalDateTime.now()
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun `select 01`(testDB: TestDB) = runTest {
        val tbl = Misc
        withTables(testDB, tbl) {
            val date = today
            val time = LocalTime.now()
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun `select 02`(testDB: TestDB) = runTest {
        val tbl = Misc
        withTables(testDB, tbl) {
            val date = today
            val time = LocalTime.now()
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun `update 02`(testDB: TestDB) = runTest {
        val tbl = Misc
        withTables(testDB, tbl) {
            val date = today
            val time = LocalTime.now()
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun `update 03`(testDB: TestDB) = runTest {
    ...
    private val zeroDateTimeTableDdl =
        """
        CREATE TABLE IF NOT EXISTS `zerodatetimetable` (
        `id` INT NOT NULL AUTO_INCREMENT,
        `dt1` datetime NOT NULL,
        `dt2` datetime NULL,
        `ts1` timestamp NOT NULL,
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun testZeroDateTimeIsNull(testDB: TestDB) = runTest {
