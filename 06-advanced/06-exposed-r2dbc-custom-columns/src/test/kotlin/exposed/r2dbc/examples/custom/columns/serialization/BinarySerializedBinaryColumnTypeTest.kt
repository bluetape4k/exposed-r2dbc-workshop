...
/**
 * Kotlin 객체를 이진 직렬화(Binary Serialization)하여 VARBINARY 컬럼에 저장하는 예제.
 *
 * `bluetape4k-exposed` 의 `binarySerializedBinary()` 확장 함수를 사용하여
 * INSERT 시 객체를 직렬화+압축하고, SELECT 시 자동으로 역직렬화합니다.
 * [java.io.Serializable]을 구현한 모든 객체를 저장할 수 있습니다.
 *
 ...
 * [Embeddable]과 [Embeddable2]는 스키마 진화 예시를 위한 데이터 클래스입니다.
 */
