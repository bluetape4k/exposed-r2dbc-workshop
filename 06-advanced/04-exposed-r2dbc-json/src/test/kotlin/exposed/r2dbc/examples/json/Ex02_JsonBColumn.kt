...
import exposed.r2dbc.examples.json.JsonTestData.JsonBArrayTable
import exposed.r2dbc.examples.json.JsonTestData.JsonBTable
 ...
 * `jsonb` 컬럼 사용 예제
 */
class Ex02_JsonBColumn: R2dbcExposedJsonTest() {
    ...
    fun `insert and select`(testDB: TestDB) = runTest {
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun `update jsonb`(testDB: TestDB) = runTest {
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun `with non serializable class`(testDB: TestDB) = runTest {
...
//    @ParameterizedTest
//    @MethodSource(ENABLE_DIALECTS_METHOD)
//    fun `DAO Functions with Json Column`(testDB: TestDB) = runTest {
...
//    }
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun `jsonb contains`(testDB: TestDB) = runTest {
        Assumptions.assumeTrue { testDB !in TestDB.ALL_H2 }
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun `json exists`(testDB: TestDB) = runTest {
        Assumptions.assumeTrue { testDB !in TestDB.ALL_H2 }
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun `jsonb extract with arrays`(testDB: TestDB) = runTest {
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun `jsonb contains with array`(testDB: TestDB) = runTest {
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun `jsonb exists with array`(testDB: TestDB) = runTest {
        Assumptions.assumeTrue { testDB !in TestDB.ALL_H2 }
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun `jsonb with defaults`(testDB: TestDB) = runTest {
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun `logger with jsonb collections`(testDB: TestDB) = runTest {
        /**
         * ```sql
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun `jsonb with nullable column`(testDB: TestDB) = runTest {
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun `jsonb with upsert`(testDB: TestDB) = runTest {
        // Assumptions.assumeTrue { testDB !in TestDB.ALL_H2_V1 }
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun `jsonb with transformer`(testDB: TestDB) = runTest {
        // Assumptions.assumeTrue { testDB !in TestDB.ALL_H2_V1 }
    ...
    @ParameterizedTest
    @MethodSource(ENABLE_DIALECTS_METHOD)
    fun `jsonb as default`(testDB: TestDB) = runTest {
        Assumptions.assumeTrue { testDB != TestDB.MYSQL_V5 }
