...
- [09-spring/06-exposed-spring-boot-r2dbc-repository](09-spring/06-exposed-spring-boot-r2dbc-repository/README.ko.md)
  Spring Boot repository scanning과 provider mapping, 단일/outer transaction 경계
