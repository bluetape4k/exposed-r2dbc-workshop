...
![구조 다이어그램 1](../../docs/images/readme-diagrams/11-high-performance-02-cache-strategies-r2dbc-ko-diagram-01.svg)

> `UserCacheRepository`: Near Cache(Caffeine) + Redis(MapCache)
> `UserCredentialsCacheRepository`: 읽기 전용 캐시 (인증정보, 코드표)
> `UserEventCacheRepository`: 비동기 배치 쓰기 (이벤트, 로그)

## 캐시 조회 흐름

![캐시 조회 흐름 2](../../docs/images/readme-diagrams/11-high-performance-02-cache-strategies-r2dbc-ko-diagram-02.svg)
...
![전략별 동작 흐름 3](../../docs/images/readme-diagrams/11-high-performance-02-cache-strategies-r2dbc-ko-diagram-03.svg)
...
![Near Cache 효과 4](../../docs/images/readme-diagrams/11-high-performance-02-cache-strategies-r2dbc-ko-diagram-04.svg)
