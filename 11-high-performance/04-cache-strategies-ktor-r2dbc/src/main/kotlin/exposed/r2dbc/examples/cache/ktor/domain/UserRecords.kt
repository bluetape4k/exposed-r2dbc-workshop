...
/**
 * 읽기/쓰기 route가 응답에 노출하는 캐시 처리 상태입니다.
 */
@Serializable
...
/**
 * Ktor 캐시 전략 예제에서 데이터베이스 행과 HTTP 응답을 함께 표현하는 사용자 record입니다.
 *
 ...
 *
 * @property cacheStatus 요청이 캐시 hit, miss, 미발견, 쓰기 중 어떤 경로를 거쳤는지 나타냅니다.
...
/**
 * 애플리케이션 프로세스 안에서 집계한 캐시 관찰 counter입니다.
 *
